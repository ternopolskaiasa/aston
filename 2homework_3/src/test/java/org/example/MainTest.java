...
class MainTest {
    ...
    @Test
    void testHandleGetUserById() throws DAOException {
        long id = 123L;
    ...
    @Test
    void testHandleGetAllUsers() throws DAOException {
    ...
    @Test
    void testHandleSaveUser() throws DAOException {
    ...
    @Test
    void testHandleUpdateUser() throws DAOException {
        long id = 123L;
        User mockUser = new User();
        mockUser.setId(id);
    ...
    @Test
    void testHandleDeleteUser() throws DAOException {
        long id = 456L;
        when(scanner.nextLine()).thenReturn(String.valueOf(id));
    ...
    @Test
    void testInvalidUpdateInput() throws DAOException {
