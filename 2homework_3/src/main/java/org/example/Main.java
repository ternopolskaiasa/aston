...
public class Main {
    ...
    void handleGetUserById() throws DAOException {
        System.out.print("Enter the id: ");
        long id = Long.parseLong(scanner.nextLine());
        System.out.println(userDAO.getUserById(id));
    }

    void handleGetAllUsers() throws DAOException {
        System.out.println(userDAO.getAllUsers().toString());
    }

    void handleSaveUser() throws DAOException {
    ...
    void handleUpdateUser() throws DAOException {
    ...
    void handleDeleteUser() throws DAOException {
        System.out.print("Enter the id: ");
        long id = Long.parseLong(scanner.nextLine());
